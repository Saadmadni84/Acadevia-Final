package com.acadevia.auth.security;

import com.acadevia.auth.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            userEmail = jwtService.extractEmail(jwt); // Use extractEmail which wraps JWT parsing logic
            ...
            // Request will fail at security check 
        }
